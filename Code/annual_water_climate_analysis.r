# annual_water_climate_analysis.R analyzes data for the snow persistence and watershed signatures project
# Authors: Edward Le (Customization/application to SP project)
...
allSitesNoStandardizationPlotFilename <- paste(correlationalPlotDir, "figS1_unstandardized_correlations_pearson.png", sep = "")
...
snowRichStandardizedGeoPlotsFilename <- paste(correlationalPlotDir, "fig05_snow_rich_correlations_geo_pearson.png", sep = "")
...
snowPoorStandardizedGeoPlotsFilename <- paste(correlationalPlotDir, "figS2_snow_poor_correlations_geo_pearson.png", sep = "")
...
snowRichStandardizedPlotsAiFilename <- paste(correlationalPlotDir, "fig06_snow_rich_correlations_pearson_ai.png", sep = "")
...
snowRichStandardizedPlotsSiFilename <- paste(correlationalPlotDir, "fig06_snow_rich_correlations_pearson_si.png", sep = "")
...
snowRichCorrelationsAiSiFilename <- paste(correlationalPlotDir, "fig06_snow_rich_correlations_pearson.png", sep = "")
...
snowPoorStandardizedPlotsAiFilename <- paste(correlationalPlotDir, "figS3_snow_poor_correlations_pearson_ai.png", sep = "")
...
snowPoorStandardizedPlotsSiFilename <- paste(correlationalPlotDir, "figS3_snow_poor_correlations_pearson_si.png", sep = "")
...
snowPoorStandardizedPlotsAiSiFilename <- paste(correlationalPlotDir, "figS3_snow_poor_correlations_pearson.png", sep = "")
