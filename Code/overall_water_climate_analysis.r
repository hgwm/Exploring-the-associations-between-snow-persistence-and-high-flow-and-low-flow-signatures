# overall_water_climate_analysis.R performs rank-based correlation on the overall data for the snow persistence and watershed signatures project
# Assumes column order is constant across all code
# Authors: Edward Le
...
lowFlowFileName <- paste(spearmanPlotDir, "fig03_low_flow_spearman.png")
...
highFlowFileName <- paste(spearmanPlotDir, "fig04_high_flow_spearman.png")
